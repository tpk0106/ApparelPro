namespace apparelPro.BusinessLogic.Services.Models.ImportExport.ILetterOfCreditCoveringLetterService
{
    public class LetterOfCreditCoveringLetterServiceModel
    {
