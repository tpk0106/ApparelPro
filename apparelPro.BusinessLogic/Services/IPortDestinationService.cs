...
namespace apparelPro.BusinessLogic.Services
{
    public interface IPortDestinationService
    {
        ...
        Task<PortDestinationServiceModel> GetPortDestinationByCodeAndCountryCodeAsync(string code, string countryCode);
       // Task<IEnumerable<PortDestinationServiceModel>> FilterBuyerByCodeAsync(string filter, int pageNumber, int pageSize);
        ...
        Task DeletePortDestinationAsync(string code, string countryCode);
    }
}
