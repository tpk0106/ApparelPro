...
{
    // Modern equivalent of legacy IN_RTN2.PRG (print run of an already-committed
    // Goods Return Note). See NotePrintEngineHelper for the shared
    // header/signature/footer scaffolding shared with every note print engine.
    public class RtnPrintEngine
    {
        public static byte[] GenerateRtnPrintPdf(RtnPrintDetailsServiceModel details)
        {
