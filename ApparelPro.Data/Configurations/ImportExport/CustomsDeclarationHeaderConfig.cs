...
namespace ApparelPro.Data.Configurations.ImportExport
{
    public class CustomsDeclarationHeaderConfig : IEntityTypeConfiguration<CustomsDeclarationHeader>
    {
        public void Configure(EntityTypeBuilder<CustomsDeclarationHeader> entity)
        {
            ...
            entity.Property(e => e.CountryOfConsignmentCode).HasColumnType("varchar(3)");
            ...
            entity.Property(e => e.CountryOfDestinationCode).HasColumnType("varchar(3)");
            ...
            entity.Property(e => e.PortOfDischargeCode).HasColumnType("varchar(3)");
            entity.Property(e => e.PlaceOfDeliveryCode).HasColumnType("varchar(3)");
