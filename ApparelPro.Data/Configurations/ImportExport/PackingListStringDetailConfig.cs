...
{
    public class PackingListStringDetailConfig : IEntityTypeConfiguration<PackingListStringDetail>
    {
        public void Configure(EntityTypeBuilder<PackingListStringDetail> entity)
        {
            entity.ToTable("PackingListStringDetails");
