    ...
    public class ServicetoAPIModelMappings : Profile
    {
        public ServicetoAPIModelMappings()
        {
           ...
           .ForMember(src => src.Flag, opt => opt.MapFrom(src => src.Flag));
            ...
            CreateMap<CompanyAddressServiceModel, CompanyAddressAPIModel>().MaxDepth(2).ReverseMap();
            CreateMap<SaveCompanyAddressAPIModel, SaveCompanyAddressServiceModel>().MaxDepth(2);
            CreateMap<CommercialInvoiceHeaderServiceModel, CommercialInvoiceHeaderAPIModel>().MaxDepth(2).ReverseMap();
            ...
            CreateMap<ValueDeclarationHeaderServiceModel, ValueDeclarationHeaderAPIModel>().MaxDepth(2).ReverseMap();
            CreateMap<ValueDeclarationLineServiceModel, ValueDeclarationLineAPIModel>().MaxDepth(2).ReverseMap();
            CreateMap<ValueDeclarationDetailServiceModel, ValueDeclarationDetailAPIModel>().MaxDepth(2);
            CreateMap<SaveValueDeclarationAPIModel, SaveValueDeclarationServiceModel>().MaxDepth(2);

            CreateMap<ExportLicenseHeaderServiceModel, ExportLicenseHeaderAPIModel>().MaxDepth(2).ReverseMap();
            CreateMap<ExportLicenseLineServiceModel, ExportLicenseLineAPIModel>().MaxDepth(2).ReverseMap();
            CreateMap<ExportLicenseDetailServiceModel, ExportLicenseDetailAPIModel>().MaxDepth(2);
            CreateMap<SaveExportLicenseAPIModel, SaveExportLicenseServiceModel>().MaxDepth(2);
            ...
            CreateMap<PackingListCartonDetailServiceModel, PackingListCartonDetailAPIModel>().MaxDepth(2).ReverseMap();
            CreateMap<PackingListStringDetailServiceModel, PackingListStringDetailAPIModel>().MaxDepth(2).ReverseMap();
            CreateMap<PackingListDetailServiceModel, PackingListDetailAPIModel>().MaxDepth(2);
            CreateMap<SavePackingListAPIModel, SavePackingListServiceModel>().MaxDepth(2);
